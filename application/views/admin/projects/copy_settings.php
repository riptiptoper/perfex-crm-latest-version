            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <hr />
                        <div class="copy-project-tasks-status-wrapper" style="display: none">
                            <p class="bold"><?php echo _l('copy_project_tasks_status'); ?></p>
                            <?php foreach ($task_statuses as $cp_task_status) { ?>
                                <div class="radio radio-primary">
                                    <input type="radio" name="copy_project_task_status" id="cp_task_status_<?php echo $cp_task_status['id']; ?>"<?php if ($cp_task_status['id'] == '1') {
    echo ' checked';
} ?>>
...
function copy_project(id, el) {
    $.ajax({
        async: false,
        type: 'get',
        url: admin_url + 'projects/getTaskStatus',
        data: {'id': id},
        success: function(result) {
            $('input[name="copy_project_task_status"]').val(result);
        },
    });
