        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel_s">
                    ...
                    ?>
                            <div class="row">
                                <div id="project_cost" class="col-md-6 <?php echo $input_field_hide_class_total_cost; ?>">
                    ...
                    ?>
                        ...
                        ?>
                         ...
                         $hasPermissionResponsibleProjectEdit = has_permission('responsible_project', '', 'edit');
                         $disable = ($hasPermissionResponsibleProjectEdit ? 0 : 1);
                        ...
                        ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <?php
                         $selected = [];
                         if (isset($project_mounter_members)) {
                             foreach ($project_mounter_members as $member) {
                                 array_push($selected, $member['staff_id']);
                             }
                         } else {
                             array_push($selected, get_staff_user_id());
                         }
                        echo render_select('project_mounters[]', $staff, ['staffid', ['firstname', 'lastname']], _l('project_montator'), $selected, ['multiple' => true, 'disabled' => $disable, 'data-actions-box' => true], [], '', '', false);
                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <?php
                                            $selected = [];
                                            if (isset($project_design_members)) {
                                                foreach ($project_design_members as $member) {
                                                    array_push($selected, $member['staff_id']);
                                                }
                                            } else {
                                                array_push($selected, get_staff_user_id());
                                            }
                                            echo render_select('project_designers[]', $staff, ['staffid', ['firstname', 'lastname']], _l('project_designer'), $selected, ['multiple' => true, 'disabled' => $disable, 'data-actions-box' => true], [], '', '', false);
                                        ?>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <?php
                                            $selected = [];
                                            if (isset($project_tech_members)) {
                                                foreach ($project_tech_members as $member) {
                                                    array_push($selected, $member['staff_id']);
                                                }
                                            } else {
                                                array_push($selected, get_staff_user_id());
                                            }
                                            echo render_select('project_technologists[]', $staff, ['staffid', ['firstname', 'lastname']], _l('project_technolog'), $selected, ['multiple' => true, 'disabled' => $disable, 'data-actions-box' => true], [], '', '', false);
                                        ?>
                                    </div>
                                </div>
