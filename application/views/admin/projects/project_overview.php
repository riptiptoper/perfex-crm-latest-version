        ...
        <div class="panel_s">
                    ...
                    <div class="col-md-12">
                        ...
                        <dl class="tw-grid tw-grid-cols-1 tw-gap-x-4 tw-gap-y-5 sm:tw-grid-cols-2">
                            ...
                            <div class="sm:tw-col-span-1 project-overview-status">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('total_amount'); ?>
                                </dt>
                                <dd class="tw-mt-1 tw-text-sm tw-text-neutral-900">
                                    <?php echo  app_format_money($total_price, $currency); ?>
                                </dd>
                            </div>
         ...
         if ($value == '') {
             continue;
                            ...
                            <?php } ?>
                            <div class="sm:tw-col-span-1 project-overview-description tc-content">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                            ...
                            <div class="sm:tw-col-span-1 project-overview-customer">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('project_mounters'); ?>
                                </dt>
                                <dd class="tw-mt-1 tw-text-sm tw-text-neutral-900">
                                    <?php foreach ($mounter_members as $item) { ?>
                                    <a
                                        href="<?php echo admin_url(); ?>profile/<?php echo $item['staff_id']; ?>">
                                        <?php echo get_staff_full_name($item['staff_id']); ?>
                                    </a><br>
                                    <?php } ?>
                                </dd>
                            </div>
                            <div class="sm:tw-col-span-1 project-overview-customer">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('project_designers'); ?>
                                </dt>
                                <dd class="tw-mt-1 tw-text-sm tw-text-neutral-900">
                                    <?php foreach ($design_members as $item) { ?>
                                    <a
                                        href="<?php echo admin_url(); ?>profile/<?php echo $item['staff_id']; ?>">
                                        <?php echo get_staff_full_name($item['staff_id']); ?>
                                    </a><br>
                            ...
                            <div class="sm:tw-col-span-1 project-overview-customer">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('project_technologists'); ?>
                                </dt>
                                <dd class="tw-mt-1 tw-text-sm tw-text-neutral-900">
                                    <?php foreach ($tech_members as $item) { ?>
                                    <a
                                        href="<?php echo admin_url(); ?>profile/<?php echo $item['staff_id']; ?>">
                                        <?php echo get_staff_full_name($item['staff_id']); ?>
                                    </a><br>
    ...
    <div class="col-md-6 project-overview-right">
        ...
        <div class="row">
            <div class="col-md-12 project-overview-expenses-finance">
                <div class="panel_s">
                    <div class="panel-body !tw-px-5 !tw-py-4" >
                        <div class="row text-center"><b>Raport Comparativ Faptic VS Scriptic</b></div>
                        <div class="row">
                            <table class="table table-bordered table-responsive" style="font-size: 10px;">
                                <thead >
                                    <th class="text-center">Tip</th>
                                    <th class="text-center">Valoare totala</th>
                                    <th class="text-center">Vanzare</th>
                                    <th class="text-center">Proiectare</th>
                                    <th class="text-center">Bon consum</th>
                                    <th class="text-center">Productie</th>
                                    <th class="text-center">Livrare</th>
                                    <th class="text-center">Montaj</th>
                                    <th class="text-center">Ajustari</th>
                                    <th class="text-center">Profit</th>
                                </thead>
                                <tbody class="text-center">
                                    <tr>
                                        <td>Scriptic</td>
                                        <td><?php echo number_format($total_price??0, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->vanzare / 100, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->proiectare / 100, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->bc / 100, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->productie / 100, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->livrare / 100, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->montaj / 100, 2); ?></td>
                                        <td></td>
                                        <td><?php echo number_format($total_price * $project->profit / 100, 2); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Faptic</td>
                                        <td><?php echo number_format($total_price??0, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->vanzare / 100, 2); ?></td>
                                        <td><?php echo number_format($proiectare??0, 2); ?></td>
                                        <td><?php echo number_format(sum_from_table(db_prefix() . 'expenses', ['where' => ['project_id' => $project->id], 'field' => 'amount']), 2); ?></td>
                                        <td><?php echo number_format($productie??0, 2); ?></td>
                                        <td><?php echo number_format($livrare??0, 2); ?></td>
                                        <td><?php echo number_format($montaj??0, 2); ?></td>
                                        <td><?php echo number_format($fara??0, 2); ?></td>
                                        <?php $profit = ($total_price - ($total_price * $project->vanzare / 100) - $productie - $livrare - $montaj - $fara -  sum_from_table(db_prefix() . 'expenses', ['where' => ['project_id' => $project->id], 'field' => 'amount']) - $proiectare) ; ?>
                                        <td><?php echo number_format($profit, 2); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Total</td>
                                        <td></td>
                                        <td><?php echo number_format($total_price * $project->vanzare / 100 - $vanzare??0, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->proiectare / 100 - $proiectare??0, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->bc / 100 - sum_from_table(db_prefix() . 'expenses', ['where' => ['project_id' => $project->id], 'field' => 'amount']), 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->productie / 100 - $productie??0, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->livrare / 100 - $livrare??0, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->montaj / 100 - $montaj??0, 2); ?></td>
                                        <td><?php echo  number_format($fara??0, 2); ?></td>
                                        <td><?php echo number_format($total_price * $project->profit / 100 - $profit, 2); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
