            ...
            <div class="modal-body">
               ...
               ?>
                   ...
                   echo ' hide';
                        ...
                        <?php $rel_id_custom_field = (isset($task) ? $task->id : false); ?>
                        <?php $lists =  $custom_fields = $this->db->get(db_prefix() . 'documentgroups')->result_array();
                        $selected = [];
                        if (isset($task->report_document)) {
                            $selected = json_decode($task->report_document);
                        }
                        echo render_select('report_document[]', $lists, ['id', ['name']], _l('Document de raportare'), $selected, ['multiple' => true, 'data-actions-box' => true], [], '', '', false); ?>
                        <hr />
