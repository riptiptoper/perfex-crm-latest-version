...
<div class="panel-body">
    ...
    <div class="table-responsive s_table">
        <table class="table estimate-items-table items table-main-estimate-edit has-calculations no-mtop">
            <thead>
                <tr>
                  ...
                  ?>
                    ...
                    <th width="15%" align="right"><?php echo _l('estimate_discount'); ?></th>
            ...
            <tbody>
                <input id="groups" hidden/>
                <tr class="main">
                    <td></td>
                    <td style="display: none"><input hidden id="group_id" ></td>
                    ...
                    <td>
                        <textarea id="manual_description" rows="4" class="form-control"
                            placeholder="<?php echo _l('estimate_table_item_description'); ?>"></textarea>
                    </td>
                    ...
                    <td>
                        <input type="number" id="discount" class="form-control"
                            placeholder="<?php echo _l('estimate_discount'); ?>">
                    </td>
                    <td>
                        <?php
                ...
                <?php if (isset($estimate) || isset($add_items)) {
                         ...
                         foreach ($add_items as $item) {
                             ...
                             $table_row .= '</td>';
                             $table_row .= '<td style="display: none" width="1%"><input hidden id="group_id" value="' . $item['group_id'] . '"/></td>';
                             ...
                             $table_row .= '<td><textarea name="' . $items_indicator . '[' . $i . '][manual_description]" class="form-control" rows="5">' . clear_textarea_breaks($item['manual_description']) . '</textarea></td>';
