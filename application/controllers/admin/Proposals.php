...
class Proposals extends AdminController
{
    ...
    public function get_categories_by_offer() {
        $id = $this->input->post('offer');
        $this->load->model('invoice_items_model');
        echo $this->invoice_items_model->categories($id);
    }

    public function get_items_by_category() {
        $id = $this->input->post('category_id');
        $this->load->model('invoice_items_model');
        echo $this->invoice_items_model->items_by_category($id);
    }
    ...
    public function get_all_categories() {
        ...
        $this->load->model('invoice_items_model');
        $group = $this->invoice_items_model->get_group_by_id($id);
        echo $this->invoice_items_model->get_groups_by_offer($group->offer_type);
    }
