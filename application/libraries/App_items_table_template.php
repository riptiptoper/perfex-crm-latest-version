...
abstract class App_items_table_template
{
    ...
    */
    ...
    {
        $html = $this->{$this->for . '_table_open_custom'}();
        $html .= '<thead>';
        $html .= $this->{$this->for . '_headings_coustom'}();
        $html .= '</thead>';
        $html .= '<tbody>';
        $html .= $this->items_costom();
        $html .= '</tbody>';
        $html .= $this->table_close();
    ...
    public function table_view($id)
    {
        ...
        $html = $this->{$this->for . '_table_open_custom_view'}();
        $html .= '<thead>';
        $html .= $this->{$this->for . '_headings_coustom'}();
        $html .= '</thead>';
        $html .= '<tbody>';
    ...
    public function pdf_table_open()
    {
        ...
        if ($discount_column)
            return '<table width="70%" bgcolor="#fff" cellspacing="0" cellpadding="8">';
        else 
            return '<table width="78%" bgcolor="#fff" cellspacing="0" cellpadding="8">';
    }

    public function pdf_table_open_custom()
    {
        return '<table width="100%" bgcolor="#fff" cellspacing="0" cellpadding="8">';
    }

    public function pdf_table_open_custom_view()
    {
        return '<table width="100%" bgcolor="#fff" cellspacing="0" cellpadding="8">';
    }
    ...
    public function description_heading()
    {
        return $this->headings['description'];
    }
    ...
    public function set_headings($alias = '')
    {
        ...
        $this->headings['description']   = _l('pdf_table_discription_heading', '', false);
