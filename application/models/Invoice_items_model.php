...
class Invoice_items_model extends App_Model
{
    ...
    public function items_by_category($id)
    {
    ...
    {
        $this->db->where('offer_type', $id);
        return json_encode($this->db->get(db_prefix() . 'items_groups')->result_array());
    }
    ...
    public function get_groups_by_offer($offer) {
