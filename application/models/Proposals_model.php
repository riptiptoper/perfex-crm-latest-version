...
class Proposals_model extends App_Model
{
    ...
    public function add($data)
    {
        ...
        if ($this->copy == false) {
            $data['content'] = 'Ofertă realizată de: {proposal_assigned}<br>Email: {Email}<br>Telefon: {Telefon}<br>{proposal_items}<br>';
        }
    ...
    public function copy($id)
    {
        ...
        foreach ($proposal->items as $item) {
            ...
            $insert_data['newitems'][$key]['manual_description'] = clear_textarea_breaks($item['manual_description']);
            $insert_data['newitems'][$key]['group_id'] = clear_textarea_breaks($item['group_id']);
