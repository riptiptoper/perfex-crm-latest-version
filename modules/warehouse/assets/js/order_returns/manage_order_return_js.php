<script>
	...
	initDataTable(table_manage_order_return, admin_url+'warehouse/table_manage_order_return',[],[], InvoiceServerParams, [0 ,'desc']);
	...
	function init_order_return(id) {
		"use strict";
		load_small_table_item_proposal(id, '#order_return_sm_view', 'delivery_id', 'warehouse/view_order_return', '.order_return_sm');
	}
	var hidden_columns = [3,4,8];
...
function open_warehouse_modal(iv, order_return_id) {
    "use strict";
      ...
      $("#warehouse_modal_wrapper").load("<?php echo admin_url('warehouse/warehouse/open_warehouse_modal'); ?>", {
