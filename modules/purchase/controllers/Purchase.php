...
/**
    ...
    public function table_item_list()
    {
        ...
        if ($this->input->post('group_id')) {
            $group_filter  = $this->input->post('group_id');
            $data['group_filter'] = 'AND group_id = ' .$group_filter;
        }

        if ($this->input->post('sub_group')) {
            $sub_group_filter  = $this->input->post('sub_group');
            $data['sub_group_filter'] = 'AND sub_group = ' .$sub_group_filter;
        }
        $this->app->get_table_data(module_views_path('purchase', 'items/table_item_list'), $data);
    }
