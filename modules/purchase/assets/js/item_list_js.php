...
var fnServerParams;
  ...
  "use strict";
    ...
    fnServerParams = {
    	...
    	"sub_group": '[name="sub_group"]',
	  }

    init_table_item_lists();
    ...
    $('select[name="sub_group"]').on('change',function(){
      init_table_item_lists();
    });
...
function init_table_item_lists() {
  "use strict";
 if ($.fn.DataTable.isDataTable('.table-table_item_list')) {
   $('.table-table_item_list').DataTable().destroy();
 }

 initDataTable('.table-table_item_list', admin_url + 'purchase/table_item_list', [0], [0], fnServerParams, [1, 'desc']);
