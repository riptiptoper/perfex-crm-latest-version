	...
	<div class="horizontal-tabs">
		<ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
			<li role="presentation" class="<?php echo ((isset($unit_tab)) && ($unit_tab == "general") ? 'active' : '') ?>">
				<a href="<?php echo admin_url('sales_agent/settings?group=currency_rates&tab=general'); ?>" aria-controls="prefix_code" role="tab">
					<i class="fa fa-wrench"></i>&nbsp;<?php echo _l('pur_general'); ?>
				</a>
			</li>
			<li role="presentation" class="<?php echo ((isset($unit_tab)) && ($unit_tab == "logs") ? 'active' : '') ?>">
				<a href="<?php echo admin_url('sales_agent/settings?group=currency_rates&tab=logs'); ?>" aria-controls="unit" role="tab">
...
<div class="tab-content">
	<div role="tabpanel" class="tab-pane active" id="prefix_code">
		<?php $this->load->view('settings/includes/currencies/'.$unit_tab); ?>
	</div>
</div>
