...
foreach ($rResult as $aRow) {
    ...
    $company .= '<a href="' . admin_url('sales_agent/sale_agent/' . $aRow['userid'] . ($isPerson && $aRow['contact_id'] ? '?group=contacts' : '')) . '">' . _l('view') . '</a>';
    ...
    if (!$isPerson) {
        $company .= ' | <a href="' . admin_url('sales_agent/sale_agent/' . $aRow['userid'] . '?group=contacts') . '">' . _l('customer_contacts') . '</a>';
    }
    if ($hasPermissionDelete) {
        $company .= ' | <a href="' . admin_url('sales_agent/delete_sale_agent/' . $aRow['userid']) . '" class="text-danger _delete">' . _l('delete') . '</a>';
    }
