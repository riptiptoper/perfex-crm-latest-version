                        ...
                        <ul class="dropdown-menu dropdown-menu-left width300" >
                           ...
                           <li class="dropdown-submenu pull-left groups">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li><a href="#" data-cview="customer_group_<?php echo html_entity_decode($group['id']); ?>" onclick="dt_custom_view('customer_group_<?php echo html_entity_decode($group['id']); ?>','.table-clients','customer_group_<?php echo html_entity_decode($group['id']); ?>'); return false;"><?php echo html_entity_decode($group['name']); ?></a></li>
                                 <?php } ?>
                              </ul>
                           </li>
                           <div class="clearfix"></div>
                           ...
                           <li class="dropdown-submenu pull-left countries">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li><a href="#" data-cview="country_<?php echo html_entity_decode($country['country_id']); ?>" onclick="dt_custom_view('country_<?php echo html_entity_decode($country['country_id']); ?>','.table-clients','country_<?php echo html_entity_decode($country['country_id']); ?>'); return false;"><?php echo html_entity_decode($country['short_name']); ?></a></li>
                                 <?php } ?>
                              </ul>
                           </li>
                           <div class="clearfix"></div>
                           ...
                           <li class="dropdown-submenu pull-left invoice">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="invoices_<?php echo html_entity_decode($status); ?>" onclick="dt_custom_view('invoices_<?php echo html_entity_decode($status); ?>','.table-clients','invoices_<?php echo html_entity_decode($status); ?>'); return false;"><?php echo _l('customer_have_invoices_by',format_invoice_status($status,'',false)); ?></a>
                                 </li>
                                 <?php } ?>
                              </ul>
                           </li>
                           ...
                           <li class="dropdown-submenu pull-left estimate">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="estimates_<?php echo html_entity_decode($status); ?>" onclick="dt_custom_view('estimates_<?php echo html_entity_decode($status); ?>','.table-clients','estimates_<?php echo html_entity_decode($status); ?>'); return false;">
                           ...
                           <li class="dropdown-submenu pull-left project">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="projects_<?php echo html_entity_decode($status['id']); ?>" onclick="dt_custom_view('projects_<?php echo html_entity_decode($status['id']); ?>','.table-clients','projects_<?php echo html_entity_decode($status['id']); ?>'); return false;">
                           ...
                           <li class="dropdown-submenu pull-left proposal">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="proposals_<?php echo html_entity_decode($status); ?>" onclick="dt_custom_view('proposals_<?php echo html_entity_decode($status); ?>','.table-clients','proposals_<?php echo html_entity_decode($status); ?>'); return false;">
                           ...
                           <li class="dropdown-submenu pull-left contract_types">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="contract_type_<?php echo html_entity_decode($type['id']); ?>" onclick="dt_custom_view('contract_type_<?php echo html_entity_decode($type['id']); ?>','.table-clients','contract_type_<?php echo html_entity_decode($type['id']); ?>'); return false;">
                           ...
                           <li class="dropdown-submenu pull-left responsible_admin">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <li>
                                    <a href="#" data-cview="responsible_admin_<?php echo html_entity_decode($cadmin['staff_id']); ?>" onclick="dt_custom_view('responsible_admin_<?php echo html_entity_decode($cadmin['staff_id']); ?>','.table-clients','responsible_admin_<?php echo html_entity_decode($cadmin['staff_id']); ?>'); return false;">
