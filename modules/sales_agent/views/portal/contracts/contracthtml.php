...
<div class="mtop15 preview-top-wrapper">
   ...
   <div class="top" data-sticky data-sticky-class="preview-sticky-header">
      <div class="container preview-sticky-container">
         <div class="row">
            <div class="col-md-12">
               <h4 class="pull-left no-mtop contract-html-subject"><?php echo html_entity_decode($contract->subject); ?><br />
                  <small><?php echo html_entity_decode($contract->type_name); ?></small>
               </h4>
         ...
         <div class="tab-content">
            <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab') || $this->input->get('tab') === 'summary'){echo ' active';} ?>" id="summary">
               ...
               <div class="row mtop20">
                  ...
                  <div class="col-md-7 contract-number">
                     <?php echo html_entity_decode($contract->id); ?>
                  </div>
                  ...
                  <div class="col-md-7 contract-type">
                     <?php echo html_entity_decode($contract->type_name); ?>
                  </div>
                  <?php } ?>
               ...
               <div class="row mtop20">
                  ...
                  <div class="col-md-7 contract-contract-signed-by">
                     <?php echo html_entity_decode($contract->acceptance_ip); ?>
                  </div>
               </div>
               <?php } ?>
            </div>
            <div role="tabpanel" class="tab-pane<?php if($this->input->get('tab') === 'discussion'){echo ' active';} ?>" id="discussion">
               ...
               <?php
                  ...
                  echo html_entity_decode($comment_html); ?>
            </div>
         </div>
      </div>
   </div>
