            ...
            <table class="table border table-striped no-margin">
                <tbody>
                   ...
                   <tr class="project-overview">
                      ...
                      <td><?php echo sa_get_group_name_item(html_entity_decode($item->group_id)) != null ? sa_get_group_name_item(html_entity_decode($item->group_id))->name : '' ; ?></td>
                   </tr>
                   ...
                   <tr class="project-overview">
                      ...
                      <td><?php echo html_entity_decode($item->unit_id) != '' && sa_get_unit_type_item($item->unit_id) != null ? sa_get_unit_type_item($item->unit_id)->unit_name : ''; ?></td>
                   </tr>
                   <tr class="project-overview">
                      <td class="bold"><?php echo _l('tax_1'); ?></td>
                      <td><?php echo html_entity_decode($item->tax) != '' && sa_get_tax_rate_item($item->tax) != null ? sa_get_tax_rate_item($item->tax)->name : '';  ?></td>
                   </tr> 
                   <tr class="project-overview">
                      <td class="bold"><?php echo _l('tax_2'); ?></td>
                      <td><?php echo html_entity_decode($item->tax2) != '' && sa_get_tax_rate_item($item->tax2) != null ? sa_get_tax_rate_item($item->tax2)->name : '';  ?></td>
                   </tr> 
                  </tbody>
            </table>
        </div>
