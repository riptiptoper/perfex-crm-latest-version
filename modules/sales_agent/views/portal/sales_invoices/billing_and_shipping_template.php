                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div id="billing_details">
                            ...
                            <?php echo sa_render_select('billing_country',$countries,array('country_id',array('short_name'),'iso2'),'billing_country',$selected); ?>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <hr />
                      ...
                      <div class="form-group no-mbot">
                        ...
                        <div id="shipping_details" class="<?php if((isset($invoice) && $invoice->include_shipping != 1) || !isset($invoice)){echo 'hide';} ?>">
                          <div class="form-group">
                            ...
                            <?php echo sa_render_select('shipping_country',$countries,array('country_id',array('short_name'),'iso2'),'shipping_country',$selected); ?>
                        </div>
                    </div>
                </div>
            </div>
